...
public final class PermissionsManage {
     ...
     */
    public static PermissionsManage with(@NonNull FragmentActivity activity) {
        return new PermissionsManage(activity);
    }

    public static PermissionsManage with(@NonNull Context context) {
        return with(PermissionUtils.getFragmentActivity(context));
    }

    public static PermissionsManage with(@NonNull Fragment fragment) {
        return with(Objects.requireNonNull(fragment.getActivity()));
    }
     ...
     * 私有化构造函数
     */
    private PermissionsManage(@NonNull FragmentActivity activity) {
        mActivity = activity;
    }
     ...
     * 设置权限组
     */
    public PermissionsManage permission(String... permissions) {
     ...
     * 设置权限组
     */
    public PermissionsManage permission(@NonNull List<String> permissions) {
        if (mPermissions == null) {
