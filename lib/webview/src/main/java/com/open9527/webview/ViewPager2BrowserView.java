...
public final class ViewPager2BrowserView extends ViewPage2WebView implements LifecycleEventObserver {
    ...
    public ViewPager2BrowserView(Context context) {
        this(context, null);
    }

    public ViewPager2BrowserView(Context context, AttributeSet attrs) {
        this(context, attrs, android.R.attr.webViewStyle);
    }

    public ViewPager2BrowserView(Context context, AttributeSet attrs, int defStyleAttr) {
        this(context, attrs, defStyleAttr, 0);
    }

    @SuppressLint("SetJavaScriptEnabled")
    public ViewPager2BrowserView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    public static class BrowserChromeClient extends WebChromeClient {
        ...
        private final ViewPager2BrowserView mWebView;

        public BrowserChromeClient(ViewPager2BrowserView view) {
            mWebView = view;
            if (mWebView == null) {
