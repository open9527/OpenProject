...
public final class NestedScrollBrowserView extends NestedScrollWebView implements LifecycleEventObserver {
    ...
    public NestedScrollBrowserView(Context context) {
        this(context, null);
    }

    public NestedScrollBrowserView(Context context, AttributeSet attrs) {
        this(context, attrs, android.R.attr.webViewStyle);
    }

    public NestedScrollBrowserView(Context context, AttributeSet attrs, int defStyleAttr) {
        this(context, attrs, defStyleAttr, 0);
    }

    @SuppressLint("SetJavaScriptEnabled")
    public NestedScrollBrowserView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    public static class BrowserChromeClient extends WebChromeClient {
        ...
        private final NestedScrollBrowserView mWebView;

        public BrowserChromeClient(NestedScrollBrowserView view) {
            mWebView = view;
            if (mWebView == null) {
