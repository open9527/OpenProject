...
#recycleview
#-keep class com.android.open9527.recycleview.*
#-keep class com.android.open9527.recycleview.**

#tab bean
-keep class com.open9527.wanandroid.pkg.bean.*{ *; }

#okhttp bean,api
-keep class com.android.open9527.common.net.data.**{ *; }
-keepclassmembernames class com.android.open9527.common.net.data** {
    <fields>;
}
-keep class com.android.open9527.common.net.server.**{ *; }
-keepclassmembernames class com.android.open9527.common.net.server** {
    <fields>;
}

-keep class com.android.open9527.pkg.request.**{ *; }
# 不混淆这些包下的字段名
-keepclassmembernames class com.android.open9527.pkg.request.** {
    <fields>;
}

# 不混淆这个包下的字段名
-keepclassmembernames class com.open9527.wanandroid.pkg.net.** {
    <fields>;
}
