package com.android.custom.pkg.video.exo.player;
...
import com.android.custom.pkg.video.exo.IPlayTarget;
import com.android.custom.pkg.video.exo.PageListPlay;
...
//            PPImageView.setBlurImageUrl(blur, coverUrl, 10);
    ...
    public void inActive() {
        ...
        PageListPlay pageListPlay = PageListPlayManager.get(mCategory);
        if (pageListPlay.playerView == null || pageListPlay.controlView == null || pageListPlay.exoPlayer == null)
            return;
