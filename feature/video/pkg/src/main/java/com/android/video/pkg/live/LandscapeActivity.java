...
import com.android.video.pkg.databinding.LiveLandscapeActivityBinding;
 ...
 * Create at 2021/5/17
 **/
public class LandscapeActivity extends BaseCommonActivity {
    ...
    protected DataBindingConfig getDataBindingConfig() {
        return new DataBindingConfig(R.layout.live_landscape_activity, BR.vm, mViewModel);
    }
    ...
    public void initView(@Nullable Bundle bundle) {
        ...
        mVideoView = ((LiveLandscapeActivityBinding) getBinding()).videoView;
